...
<body>
<?php $protokol = 'Интересные ссылки'; include_once("analyticstracking.php") ?>
    <div>
        <!--BEGIN THEME SETTING-->
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Интересные ссылки</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
				...
				<?php 
        			...
        			while ($row=mysql_fetch_array($res)) 
        			{
		           		$namehref = $row[namehref];               
                                        echo '<li data-id="3" class="dd-item">  ';
                                        echo '<div class="dd3-content"><a href="listsite.php?opis='.$row[id].'">'.$namehref.'</a></div>';
                                        echo '</li>';
	        		}
				?>
                                    </ol>
