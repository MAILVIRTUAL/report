                ...
                <div class="page-content">
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <div class="col-lg-12">
                              <div class="col-lg-6">
             <script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=n7ycxiVSOtBYEKFaupnjnEzQHRbHZZlt&width=600&height=441&lang=ru_RU&sourceType=constructor"></script>            
                                    </div>
                                    <div class="col-lg-6"><p>ООО ФИТА. </p>
                                        <ol class="pll">
                                            <li>Телефон для связи 8 (3532) 27-15-63</li>
                                            <li>Факс   8 (3532) 70-28-83</li>
                                            <li>Skype (Izofen74) </li>
                                            <li>ICQ  443039</li>
                                            <li>Email Kupinov@mail.ru</li>
                                            <li>Wot  +79033671563</li>
                                            <li>Вопрос через сайт</li>
                                            <li>Бумажная поста г. Оренбург ул. Восточная 27 оф 9</li>
                                        </ol>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12"><h2 class="mbxl">Контакты с сотрудниками</h2>
