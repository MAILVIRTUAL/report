  ...
  // 
   if (isset($_GET ['tema']))
   {
	...
	$qvest       = $_GET ['qvest']; 
        ...
        $query = "INSERT INTO avtoklik (namesite,opis) VALUES ('".$tema."','".$qvest."')";
        $res = mysql_query($query);
        if ($res == 'true')
        {
...
<form action="avtoklik.php" class="form-horizontal"><h3>Добавить ссылку для посешение.</h3>
<?php  
if ($metkahorvop == "yes")
{
?>
<div class="note note-success"><h4 class="box-heading">Информация добавлена.</h4>
 ...
 <p>Ваша ссылка добавлена в базу.</p></div>
...
<div class="form-group"><label class="col-sm-3 control-label">Ссылка для посещения</label>
                                           ...
                                           <div class="form-group">  <label class="col-sm-3 control-label">Описание ссылки</label>
