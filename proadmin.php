...
if (isset($_GET['Pflogin']) and isset($_GET['Pfpass']))
  {
   ...
   {  
        ...
        // Если клиент смотрит или Админитратор просматривает пользователей
...
?>
                            ...
                            <div class="radio"><label class="radio-inline"><input type="radio" value="0" name="gender" checked="checked"/>&nbsp;
                                                                Мужской</label><label class="radio-inline"><input type="radio" value="1" name="gender"/>&nbsp;
                                                                Женский</label></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-3 control-label">День рождения</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-4"><select class="form-control">
                                                            ...
                                                            <option>Литератор</option>
                                                            <option>Почтальен</option>
                                                        </select></div>
                                                    </div>
                                                </div>
                                            </div>
