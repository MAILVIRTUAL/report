...
<body>
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <ul id="generalTab" class="nav nav-tabs responsive">
                            <li class="active"><a href="#alert-tab" data-toggle="tab">Задачи</a></li>
                            <li><a href="#note-tab" data-toggle="tab">Сообщения</a></li>
                            <li><a href="#label-badge-tab" data-toggle="tab">Объявления</a></li>
                            <li><a href="#pagination-tab" data-toggle="tab">Электронная почта</a></li>
                            <li><a href="#input-group-tab" data-toggle="tab">Бумажная почта</a></li>
                        </ul>
                        <div id="generalTabContent" class="tab-content responsive">
                            <div id="alert-tab" class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-lg-6"><h3>В работе</h3>
  <?php                                   
  ...
  echo '<div class="alert alert-success"><strong>'.$name.'</strong> You successfully read this important alert message.</div>  ';
                                       // echo "<div class="alert alert-info"><strong>Heads up!</strong> This alert needs your attention, but it's not super important.</div>";
                                       // echo "<div class="alert alert-warning"><strong>Warning!</strong> Best check yo self, you're not looking too good.</div>";
  ...
  echo '<span class="label label-default"><a href="URL">Удалить</a></span>';
  echo '<span class="label label-primary"><a href="URL">Редактировать</a></span>';
  echo '<span class="label label-success"><a href="URL">Выполнено</a></span>';
  echo '<span class="label label-warning"><a href="URL">Отменено</a></span>';
  echo '<span class="label label-info"><a href="URL">Перенаправить</a></span>';
  echo '<span class="label label-danger"><a href="URL">В процессе</a></span>';
  ...
  ?>     
                                        ...
                                        <div class="alert alert-warning alert-dismissable">
                                            ...
                                            <strong>Добавить!</strong>Добавить новое задание
                                        </div>
                                    </div>
                                    <div class="col-lg-6"><h3>Закрытые</h3>
 ...
 <?php                                   
        ...
        while ($row=mysql_fetch_array($res)) 
        {
            ...
            $kom   = $row[kom];
                                     ...
                                     echo' <div class="alert alert-success"><strong>Well done!</strong> You successfully read <a href="#" class="alert-link">this important alert message</a>.</div>';
