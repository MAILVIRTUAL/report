...
// какую картинку включать по ссылке
 if (isset($_GET ['pic']))
   {
        $pic   = $_GET ['pic'];
    }
  else
    {
        ...
        $userstable = "pictfiles";
        mysql_select_db($dbName); 
        $query = "SELECT * FROM $userstable WHERE id = '".$pic."' ";
        $res = mysql_query($query) ;  
        while ($row=mysql_fetch_array($res)) 
        {
            $filename = $row[name];
        ...
        // прописываем информацию юзеру для памяти
        $userstable = "user";
        mysql_select_db($dbName); 
        $query = "UPDATE $userstable SET pictgirl = '".$pic."' WHERE login = '".$_SESSION['Login']."' and pass = '".$_SESSION['Password']."'";
        // echo $query;
        $res = mysql_query($query); 
...
// ишем 4 новости для продолжения
  ...
  // подсчитываем колличетво блогов и выбкраем случайные
  $userstable = "blogi";
  mysql_select_db($dbName); 
                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <div class="col-lg-12">
                              <div class="col-lg-6">
<?php
                                      echo  '<iframe src="files/'.$filename.'" style="width: 100%; height:340px; border:0"></iframe>';


                                     $userstable = "pictfiles";
                                     mysql_select_db($dbName); 
                                     $query = "SELECT * FROM $userstable WHERE 1=1 ";
        			     $res10 = mysql_query($query) ;  
				     $metka10 = 'no';
				     $noner10 = 1;	
...
?>
                                        ...
                                        <div class="col-lg-4"><h3>Блок картинок</h3>
                                        <ul class="pagination pagination-lg mtm mbm">
                                            
                                            <li><a href="pictlist.php?pic=7">1</a></li>
                                            <li><a href="pictlist.php?pic=400">400</a></li>
                                            <li><a href="pictlist.php?pic=800">800</a></li>
                                            <li><a href="pictlist.php?pic=1000">1000</a></li>
                                            <li><a href="pictlist.php?pic=1200">1200</a></li>
                                            
                                        </ul>

    					<ul class="pager">
                                            <?php
                                            echo '<li><a href="pictlist.php?pic='.$idpredZN.'">Предыдущий</a></li>';
                                            echo '<li><a href="pictlist.php?pic='.$idsledZN.'">Следующий</a></li>';
					    ?>
                                        </ul>
...
<?php
                                  ...
                                  echo '<div class="col-lg-6"><p><p><a href="files/'.$filename.'" download></a> .</p>';
?>
...
<?php
        $userstable = "pictfiles";
        mysql_select_db($dbName); 
        $nonermerka = $nonermerka -10;
        $queryall = "SELECT * FROM $userstable WHERE 1=1 Limit ".$nonermerka.",20";
        $resall = mysql_query($queryall);  

        while ($rowall=mysql_fetch_array($resall)) 
        {
            $filenameall = $rowall[name];
            $ideng    = $rowall[id];
            echo ('<li><a href="pictlist.php?pic='.$ideng.'">'.$filenameall.'</a></li>');
        }
?>
